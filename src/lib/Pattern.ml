 ...
 * CONTENT 
 *
 *   A library for generic pattern matching of symbols with respect to an alphabet = list of symbols
 ...
 *
 *   Requirement
 *    - Module  :  MyList.cmo MyString.cmo Tricks.cmo Pretty.cmo Html.cmo
 *    - Library :
 *   Compilation:  ocamlc      MyList.cmo MyString.cmo Tricks.cmo Pretty.cmo Html.cmo Pattern.ml
 *   Interpreter:  ledit ocaml MyList.cmo MyString.cmo Tricks.cmo Pretty.cmo Html.cmo Pattern.cmo
 *)
